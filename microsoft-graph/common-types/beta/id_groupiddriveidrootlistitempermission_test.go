...
func TestNewGroupIdDriveIdRootListItemPermissionID(t *testing.T) {
	id := NewGroupIdDriveIdRootListItemPermissionID("groupId", "driveId", "permissionId")
...
func TestFormatGroupIdDriveIdRootListItemPermissionID(t *testing.T) {
	actual := NewGroupIdDriveIdRootListItemPermissionID("groupId", "driveId", "permissionId").ID()
	expected := "/groups/groupId/drives/driveId/root/listItem/permissions/permissionId"
	if actual != expected {
...
func TestParseGroupIdDriveIdRootListItemPermissionID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/groups/groupId/drives/driveId/root/listItem/permissions",
			Error: true,
		},
		{
			// Valid URI
			Input: "/groups/groupId/drives/driveId/root/listItem/permissions/permissionId",
			Expected: &GroupIdDriveIdRootListItemPermissionId{
				GroupId:      "groupId",
				DriveId:      "driveId",
		...
		},
		{
			...
			Input: "/groups/groupId/drives/driveId/root/listItem/permissions/permissionId/extra",
			Error: true,
		},
	}
