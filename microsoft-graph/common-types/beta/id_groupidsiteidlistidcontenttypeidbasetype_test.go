...
func TestNewGroupIdSiteIdListIdContentTypeIdBaseTypeID(t *testing.T) {
	id := NewGroupIdSiteIdListIdContentTypeIdBaseTypeID("groupId", "siteId", "listId", "contentTypeId", "contentTypeId1")
...
func TestFormatGroupIdSiteIdListIdContentTypeIdBaseTypeID(t *testing.T) {
	actual := NewGroupIdSiteIdListIdContentTypeIdBaseTypeID("groupId", "siteId", "listId", "contentTypeId", "contentTypeId1").ID()
	expected := "/groups/groupId/sites/siteId/lists/listId/contentTypes/contentTypeId/baseTypes/contentTypeId1"
	if actual != expected {
...
func TestParseGroupIdSiteIdListIdContentTypeIdBaseTypeID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/groups/groupId/sites/siteId/lists/listId/contentTypes/contentTypeId/baseTypes",
			Error: true,
		},
		{
			// Valid URI
			Input: "/groups/groupId/sites/siteId/lists/listId/contentTypes/contentTypeId/baseTypes/contentTypeId1",
			Expected: &GroupIdSiteIdListIdContentTypeIdBaseTypeId{
				GroupId:        "groupId",
				SiteId:         "siteId",
				ListId:         "listId",
		...
		},
		{
			...
			Input: "/groups/groupId/sites/siteId/lists/listId/contentTypes/contentTypeId/baseTypes/contentTypeId1/extra",
			Error: true,
		},
	}
