...
func TestNewUserIdDriveIdListItemIdActivityID(t *testing.T) {
	id := NewUserIdDriveIdListItemIdActivityID("userId", "driveId", "listItemId", "itemActivityOLDId")
...
func TestFormatUserIdDriveIdListItemIdActivityID(t *testing.T) {
	actual := NewUserIdDriveIdListItemIdActivityID("userId", "driveId", "listItemId", "itemActivityOLDId").ID()
	expected := "/users/userId/drives/driveId/list/items/listItemId/activities/itemActivityOLDId"
	if actual != expected {
...
func TestParseUserIdDriveIdListItemIdActivityID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/users/userId/drives/driveId/list/items/listItemId/activities",
			Error: true,
		},
		{
			// Valid URI
			Input: "/users/userId/drives/driveId/list/items/listItemId/activities/itemActivityOLDId",
			Expected: &UserIdDriveIdListItemIdActivityId{
				UserId:            "userId",
				DriveId:           "driveId",
		...
		},
		{
			...
			Input: "/users/userId/drives/driveId/list/items/listItemId/activities/itemActivityOLDId/extra",
			Error: true,
		},
	}
