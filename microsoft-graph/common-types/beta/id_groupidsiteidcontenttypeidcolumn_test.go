...
func TestNewGroupIdSiteIdContentTypeIdColumnID(t *testing.T) {
	id := NewGroupIdSiteIdContentTypeIdColumnID("groupId", "siteId", "contentTypeId", "columnDefinitionId")
...
func TestFormatGroupIdSiteIdContentTypeIdColumnID(t *testing.T) {
	actual := NewGroupIdSiteIdContentTypeIdColumnID("groupId", "siteId", "contentTypeId", "columnDefinitionId").ID()
	expected := "/groups/groupId/sites/siteId/contentTypes/contentTypeId/columns/columnDefinitionId"
	if actual != expected {
...
func TestParseGroupIdSiteIdContentTypeIdColumnID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/groups/groupId/sites/siteId/contentTypes/contentTypeId/columns",
			Error: true,
		},
		{
			// Valid URI
			Input: "/groups/groupId/sites/siteId/contentTypes/contentTypeId/columns/columnDefinitionId",
			Expected: &GroupIdSiteIdContentTypeIdColumnId{
				GroupId:            "groupId",
				SiteId:             "siteId",
		...
		},
		{
			...
			Input: "/groups/groupId/sites/siteId/contentTypes/contentTypeId/columns/columnDefinitionId/extra",
			Error: true,
		},
	}
