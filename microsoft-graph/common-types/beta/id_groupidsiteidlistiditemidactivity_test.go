...
func TestNewGroupIdSiteIdListIdItemIdActivityID(t *testing.T) {
	id := NewGroupIdSiteIdListIdItemIdActivityID("groupId", "siteId", "listId", "listItemId", "itemActivityOLDId")
...
func TestFormatGroupIdSiteIdListIdItemIdActivityID(t *testing.T) {
	actual := NewGroupIdSiteIdListIdItemIdActivityID("groupId", "siteId", "listId", "listItemId", "itemActivityOLDId").ID()
	expected := "/groups/groupId/sites/siteId/lists/listId/items/listItemId/activities/itemActivityOLDId"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseGroupIdSiteIdListIdItemIdActivityID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupIdSiteIdListIdItemIdActivityId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		{
			// Incomplete URI
			Input: "/groups/groupId/sites/siteId/lists/listId/items/listItemId/activities",
			Error: true,
		},
		{
			// Valid URI
			Input: "/groups/groupId/sites/siteId/lists/listId/items/listItemId/activities/itemActivityOLDId",
			Expected: &GroupIdSiteIdListIdItemIdActivityId{
				GroupId:           "groupId",
				SiteId:            "siteId",
				ListId:            "listId",
		...
		},
		{
			...
			Input: "/groups/groupId/sites/siteId/lists/listId/items/listItemId/activities/itemActivityOLDId/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseGroupIdSiteIdListIdItemIdActivityID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupIdSiteIdListIdItemIdActivityIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupIdSiteIdListIdItemIdActivityId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupIdSiteIdListIdItemIdActivityIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupIdSiteIdListIdItemIdActivityId(t *testing.T) {
	segments := GroupIdSiteIdListIdItemIdActivityId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupIdSiteIdListIdItemIdActivityId has no segments")
	}
