...
func TestNewUserIdMailFolderIdChildFolderIdMessageIdMentionID(t *testing.T) {
	id := NewUserIdMailFolderIdChildFolderIdMessageIdMentionID("userId", "mailFolderId", "mailFolderId1", "messageId", "mentionId")
...
func TestFormatUserIdMailFolderIdChildFolderIdMessageIdMentionID(t *testing.T) {
	actual := NewUserIdMailFolderIdChildFolderIdMessageIdMentionID("userId", "mailFolderId", "mailFolderId1", "messageId", "mentionId").ID()
	expected := "/users/userId/mailFolders/mailFolderId/childFolders/mailFolderId1/messages/messageId/mentions/mentionId"
	if actual != expected {
...
func TestParseUserIdMailFolderIdChildFolderIdMessageIdMentionID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/users/userId/mailFolders/mailFolderId/childFolders/mailFolderId1/messages/messageId/mentions",
			Error: true,
		},
		{
			// Valid URI
			Input: "/users/userId/mailFolders/mailFolderId/childFolders/mailFolderId1/messages/messageId/mentions/mentionId",
			Expected: &UserIdMailFolderIdChildFolderIdMessageIdMentionId{
				UserId:        "userId",
		...
		},
		{
			...
			Input: "/users/userId/mailFolders/mailFolderId/childFolders/mailFolderId1/messages/messageId/mentions/mentionId/extra",
			Error: true,
		},
	}
