...
func TestNewUserIdDeviceIdTransitiveMemberOfID(t *testing.T) {
	id := NewUserIdDeviceIdTransitiveMemberOfID("userId", "deviceId", "directoryObjectId")
...
func TestFormatUserIdDeviceIdTransitiveMemberOfID(t *testing.T) {
	actual := NewUserIdDeviceIdTransitiveMemberOfID("userId", "deviceId", "directoryObjectId").ID()
	expected := "/users/userId/devices/deviceId/transitiveMemberOf/directoryObjectId"
	if actual != expected {
...
func TestParseUserIdDeviceIdTransitiveMemberOfID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/users/userId/devices/deviceId/transitiveMemberOf",
			Error: true,
		},
		{
			// Valid URI
			Input: "/users/userId/devices/deviceId/transitiveMemberOf/directoryObjectId",
			Expected: &UserIdDeviceIdTransitiveMemberOfId{
				UserId:            "userId",
				DeviceId:          "deviceId",
		...
		},
		{
			...
			Input: "/users/userId/devices/deviceId/transitiveMemberOf/directoryObjectId/extra",
			Error: true,
		},
	}
