...
func TestNewGroupIdSiteIdExternalColumnID(t *testing.T) {
	id := NewGroupIdSiteIdExternalColumnID("groupId", "siteId", "columnDefinitionId")
...
func TestFormatGroupIdSiteIdExternalColumnID(t *testing.T) {
	actual := NewGroupIdSiteIdExternalColumnID("groupId", "siteId", "columnDefinitionId").ID()
	expected := "/groups/groupId/sites/siteId/externalColumns/columnDefinitionId"
	if actual != expected {
...
func TestParseGroupIdSiteIdExternalColumnID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/groups/groupId/sites/siteId/externalColumns",
			Error: true,
		},
		{
			// Valid URI
			Input: "/groups/groupId/sites/siteId/externalColumns/columnDefinitionId",
			Expected: &GroupIdSiteIdExternalColumnId{
				GroupId:            "groupId",
				SiteId:             "siteId",
		...
		},
		{
			...
			Input: "/groups/groupId/sites/siteId/externalColumns/columnDefinitionId/extra",
			Error: true,
		},
	}
