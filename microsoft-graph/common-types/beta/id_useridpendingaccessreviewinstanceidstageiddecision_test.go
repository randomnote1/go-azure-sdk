...
func TestNewUserIdPendingAccessReviewInstanceIdStageIdDecisionID(t *testing.T) {
	id := NewUserIdPendingAccessReviewInstanceIdStageIdDecisionID("userId", "accessReviewInstanceId", "accessReviewStageId", "accessReviewInstanceDecisionItemId")
...
func TestFormatUserIdPendingAccessReviewInstanceIdStageIdDecisionID(t *testing.T) {
	actual := NewUserIdPendingAccessReviewInstanceIdStageIdDecisionID("userId", "accessReviewInstanceId", "accessReviewStageId", "accessReviewInstanceDecisionItemId").ID()
	expected := "/users/userId/pendingAccessReviewInstances/accessReviewInstanceId/stages/accessReviewStageId/decisions/accessReviewInstanceDecisionItemId"
	if actual != expected {
...
func TestParseUserIdPendingAccessReviewInstanceIdStageIdDecisionID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/users/userId/pendingAccessReviewInstances/accessReviewInstanceId/stages/accessReviewStageId/decisions/accessReviewInstanceDecisionItemId/extra",
			Error: true,
		},
	}
