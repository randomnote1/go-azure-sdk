...
func TestNewGroupIdSiteIdOnenoteNotebookIdSectionGroupIdSectionID(t *testing.T) {
	id := NewGroupIdSiteIdOnenoteNotebookIdSectionGroupIdSectionID("groupId", "siteId", "notebookId", "sectionGroupId", "onenoteSectionId")
...
func TestFormatGroupIdSiteIdOnenoteNotebookIdSectionGroupIdSectionID(t *testing.T) {
	actual := NewGroupIdSiteIdOnenoteNotebookIdSectionGroupIdSectionID("groupId", "siteId", "notebookId", "sectionGroupId", "onenoteSectionId").ID()
	expected := "/groups/groupId/sites/siteId/onenote/notebooks/notebookId/sectionGroups/sectionGroupId/sections/onenoteSectionId"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseGroupIdSiteIdOnenoteNotebookIdSectionGroupIdSectionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupIdSiteIdOnenoteNotebookIdSectionGroupIdSectionId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		},
		{
			...
			Input: "/groups/groupId/sites/siteId/onenote/notebooks/notebookId/sectionGroups/sectionGroupId/sections/onenoteSectionId/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseGroupIdSiteIdOnenoteNotebookIdSectionGroupIdSectionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupIdSiteIdOnenoteNotebookIdSectionGroupIdSectionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupIdSiteIdOnenoteNotebookIdSectionGroupIdSectionId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupIdSiteIdOnenoteNotebookIdSectionGroupIdSectionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupIdSiteIdOnenoteNotebookIdSectionGroupIdSectionId(t *testing.T) {
	segments := GroupIdSiteIdOnenoteNotebookIdSectionGroupIdSectionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupIdSiteIdOnenoteNotebookIdSectionGroupIdSectionId has no segments")
	}
