...
func TestNewUserIdSponsorID(t *testing.T) {
	id := NewUserIdSponsorID("userId", "directoryObjectId")
...
func TestFormatUserIdSponsorID(t *testing.T) {
	actual := NewUserIdSponsorID("userId", "directoryObjectId").ID()
	expected := "/users/userId/sponsors/directoryObjectId"
	if actual != expected {
...
func TestParseUserIdSponsorID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/users/userId/sponsors",
			Error: true,
		},
		{
			// Valid URI
			Input: "/users/userId/sponsors/directoryObjectId",
			Expected: &UserIdSponsorId{
				UserId:            "userId",
		...
		},
		{
			...
			Input: "/users/userId/sponsors/directoryObjectId/extra",
			Error: true,
		},
	}
