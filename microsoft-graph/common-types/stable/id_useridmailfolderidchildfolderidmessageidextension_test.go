...
func TestNewUserIdMailFolderIdChildFolderIdMessageIdExtensionID(t *testing.T) {
	id := NewUserIdMailFolderIdChildFolderIdMessageIdExtensionID("userId", "mailFolderId", "mailFolderId1", "messageId", "extensionId")
...
func TestFormatUserIdMailFolderIdChildFolderIdMessageIdExtensionID(t *testing.T) {
	actual := NewUserIdMailFolderIdChildFolderIdMessageIdExtensionID("userId", "mailFolderId", "mailFolderId1", "messageId", "extensionId").ID()
	expected := "/users/userId/mailFolders/mailFolderId/childFolders/mailFolderId1/messages/messageId/extensions/extensionId"
	if actual != expected {
...
func TestParseUserIdMailFolderIdChildFolderIdMessageIdExtensionID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/users/userId/mailFolders/mailFolderId/childFolders/mailFolderId1/messages/messageId/extensions",
			Error: true,
		},
		{
			// Valid URI
			Input: "/users/userId/mailFolders/mailFolderId/childFolders/mailFolderId1/messages/messageId/extensions/extensionId",
			Expected: &UserIdMailFolderIdChildFolderIdMessageIdExtensionId{
				UserId:        "userId",
		...
		},
		{
			...
			Input: "/users/userId/mailFolders/mailFolderId/childFolders/mailFolderId1/messages/messageId/extensions/extensionId/extra",
			Error: true,
		},
	}
