...
func TestNewGroupIdSiteIdListIdContentTypeID(t *testing.T) {
	id := NewGroupIdSiteIdListIdContentTypeID("groupId", "siteId", "listId", "contentTypeId")
...
func TestFormatGroupIdSiteIdListIdContentTypeID(t *testing.T) {
	actual := NewGroupIdSiteIdListIdContentTypeID("groupId", "siteId", "listId", "contentTypeId").ID()
	expected := "/groups/groupId/sites/siteId/lists/listId/contentTypes/contentTypeId"
	if actual != expected {
...
func TestParseGroupIdSiteIdListIdContentTypeID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/groups/groupId/sites/siteId/lists/listId/contentTypes/contentTypeId/extra",
			Error: true,
		},
	}
